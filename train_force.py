...
# basic settings
model_dir = "ocp_schnet_model_forces"  # directory that will be created for storing model
...
val_dataset = AtomsData("ocp1k_adslab_val_schnet.db", 
                        load_only=properties,
                        environment_provider=environment_provider,
                       )
...
per_atom = dict(energy=False, forces=False)
means, stddevs = train_loader.get_statistics(
    ["energy"], single_atom_ref=atomrefs, divide_by_atoms=per_atom
)
